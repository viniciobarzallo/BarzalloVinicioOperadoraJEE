...
a persistence unit "BarzalloVinicioSRIJEEPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "BarzalloVinicioSRIJEE\pom.xml":
...
artifact ("BarzalloVinicioSRIJEE.war") is already built. You can build
